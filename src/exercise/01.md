...
To avoid the warning about switching between controlled and uncontrolled input, remember to initialize the value that is passed to input (avoid sending undefined).
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=joseluiscullcay%40gmail.com).
